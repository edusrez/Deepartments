 ...
 * the binder?.register buckets + the 9 GLOBAL host-plane tool registrations
...
import type { DeliveryRow, MessageRecord, DeliveryStatus, DeliveryRedelivererDeps } from '../messages.js'
import {
...
import type { HealthSessionEvent, InterruptedPostInput, PostActivityInput, HostWaitPostInput, SessionContextInput } from '../health.js'
import {
...
import { isArchivedSession, buildHeadRotationSeed } from '../session-rotation.js'
...
import type { PostEntry, RegistryStore, HostEntry, HostEntryLike } from '../registry.js'
import { parseJobDefFrontmatter, jobDirFor } from '../jobs.js'
import type { CalendarEntry, SchedulerAutoRunFinding } from '../jobs.js'
...
import { buildSubagentOrientation } from '../../role-orient.js'
...
// bodies use (via the drop-in bridge ../feedback.js — no cycle).
import { FeedbackStore, isTerminalEstado } from '../feedback.js'
import type { FeedbackEstado, FeedbackInput, FeedbackListOptions, FeedbackListResult, FeedbackRecord, FeedbackSeveridad, FeedbackTipo, FeedbackUpdateInput } from '../feedback.js'
...
import type { DeliveryEngine, BusMemberProfile, BusSendResult, CatalogRoute, DeliveryInterruptOptions, BusSurface, Binder } from '../delivery.js'
...
import type { DeepartmentsEndpointDeps, EndpointPostEntryLike, PresenceState } from '../gui.js'
import type { WakePackService, HostSleepSurfacePlan } from '../wakepack.js'
...
// =========================================================================
  ...
  // + the boot re-delivery driver + guiEndpointDeps + the Binder buckets
  // (binder?.register — bus / deliver / wakepack / lifecycle / redeliver /
  // gui / pooler / jobs / health) + the W1 scheduler / W6 health builder
  // closures + the 9 GLOBAL host-plane tool registrations + the disposal
  // ctx.effect — the same closures, the same order, the same semantics).
  // =========================================================================
