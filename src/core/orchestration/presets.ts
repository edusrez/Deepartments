...
import type { SubagentRole, SubagentRolesService } from '../../role-orient.js'

// Local mirror of the bundle-local `Session` (the wake-pack's roleForSession
// reads the live agent session via SessionId — the type comes from dsh-session
// directly).
import { appendToolsetAudit } from '../../toolset-audit.js'
import { buildSleepJournalMessage } from '../lifecycle.js'
...
import type { HealthSessionEvent, HostWaitPostInput, HeartbeatRow } from '../health.js'
