/**
 * normalize-client-banner.mjs (packages/dshd-gui)
 *
 ...
 *
 * dshd-gui phase: this is the PACKAGE copy of the bundle's
 * scripts/normalize-client-banner.mjs (same envelope, same id
 * "dsh-deepartments" — the client plugin identity stays the deepartments
 * client, so a package-produced bundle is byte-identical to the bundle's own).
 * The ROOT is derived from THIS script's location, so running it inside the
 * package writes packages/dshd-gui/client/client.js.
 */
